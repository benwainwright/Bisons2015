    ...
    <?php } ?>
            ...
            <div class='committeeList'>
                ...
                <div class='albumMeta'>
                            ...
                            <li><h3><?php echo get_post_meta( get_the_id(), 'posname', true) ?></strong> (<?php echo get_post_meta( get_post_meta( get_the_id(), 'incumbent', true ), 'name', true); ?>)</h3>
</li>
                                <?php if(get_post_meta( get_the_id(), 'posemail', true)) { ?><li><a href='mailto:<?php echo get_post_meta( get_the_id(), 'posemail', true) ?>'><?php echo get_post_meta( get_the_id(), 'posemail', true) ?></a></li><?php } ?>
                                <?php if(get_post_meta( get_the_id(), 'posphone', true)) { ?><li><a href='tel:<?php echo $phonenum ?>'><?php echo $phonenum ?></a></li><?php } ?>
