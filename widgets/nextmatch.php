    ...
    public function widget( $args, $instance) 
    {
		...
		if ( $next_match_query->have_posts() ) {
			...
			while ( $next_match_query->have_posts() )
			{
				...
				echo "<li><i class='fa fa-flag'></i>Bristol Bisons RFC VS " . ( get_post_meta( get_the_id(), 'fixture_team', true ) ? get_the_title( get_post_meta( get_the_id(), 'fixture_team', true ) ) : 'No Team' ) . "</li>";
				echo "<li><a href='".get_permalink()."'>More...</a></li>";
				echo "</ul>";
			}
