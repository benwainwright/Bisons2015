...
function add_custom_forms ( $post ) {
    ...
    for($i = 0; $i < $_GET['newPlayerNumber']; $i++) {

	    add_meta_box(
	        'attendance_register_add_new_player' . $i,
	        'Add New Player(s)...',
...
function register_add_new_player ( $post, $metabox ) { include( dirname(__FILE__) . '/../postforms/new_player.php'); }
