...
<header class='header'>
    ...
    <?php if ( current_user_can('edit_post', get_the_ID() ) ) { ?>
        <li><a class='fa fa-plus-square' href='<?php echo $GLOBALS['blog_info']['url']; ?>/wp-admin/post-new.php?post_type=events'>Add</a></li>
    <?php } ?>
        <li><a class='fa fa-rss-square' href='<?php echo  str_replace ( 'http://', 'webcal://', site_url('/calendar.ics?of=events'))?>'>iCal (events)<a/></li>
